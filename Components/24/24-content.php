        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-3">
                        ...
                        <ul >
                                <li class="li-img">
                                    <div class="start-product">
                                        <img src="http://<?php echo $url_path ?>./images/shop-list-img-1.png"
                                            alt="product-imag-1" />
                                    </div>
                                </li>
                                <li >
                    ...
                    <div class="new">
                            <img src="http://<?php echo $url_path ?>./images/shop-sidebar-img-1.jpg"
                             alt="product-imag-1" />
                    </div>
                    <div class="sliathos">
                        <img src="http://<?php echo $url_path ?>./images/event-sidebar-banner-2.jpg"
                                alt="product-imag-1" />
                        </div>
                </div>
            </div>
