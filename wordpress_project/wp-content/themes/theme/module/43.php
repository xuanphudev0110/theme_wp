...
<div class="type-43">
    <div class="container">
        <div class="row">
            <div class="col-xl-6 col-col">
                ...
                <img src="<?php bloginfo("template_directory"); ?>/images/lan-rev-4-img-1.jpg" alt="">
                </div>
            </div>
            <div class="col-xl-6">
            ...
            <div class="tripadvisor">
                ...
                <img src="<?php bloginfo("template_directory"); ?>/images/lan-rev-2-img-4.png" alt="">
                <p>tripadvisor</p>
            </div>
        </div>
    ...
    <div class="banner-wave">
        <img src="<?php bloginfo("template_directory"); ?>/images/lan-rev-img-2.png" alt="lan-rev-img-2.png">
