   ...
   <div class="container">
      ...
      <div class="row">
         <div class="col-lg-3 col-md-6 col-sm-12">
            <div class="sea-travel">
               <img src="<?php bloginfo("template_directory"); ?>/images/icon4.png" alt="Icon1">
         ...
         <div class="col-lg-3 col-md-6 col-sm-12">
            <div class="sea-travel">
               <img src="<?php bloginfo("template_directory"); ?>/images/icon3.png" alt="Icon1">
         ...
         <div class="col-lg-3 col-md-6 col-sm-12">
            <div class="sea-travel">
               <img src="<?php bloginfo("template_directory"); ?>/images/icon2.png" alt="Icon1">
         ...
         <div class="col-lg-3 col-md-6 col-sm-12">
            <div class="sea-travel">
               <img src="<?php bloginfo("template_directory"); ?>/images/icon1.png" alt="Icon1">
      ...
      <div class="row over-ten">
         <div class="col-lg-4 col-md-12">
            <div class="banner">
               <img src="<?php bloginfo("template_directory"); ?>/images/49/10.png" alt="Number">
         ...
         <div class="col-lg-4 col-md-6">
            <div class="img-over">
               <img src="<?php bloginfo("template_directory"); ?>/images/49/1.jpg" alt="">
            </div>
         </div>
         <div class="col-lg-4 col-md-6 margin-img-over2">
            <div class="img-over">
               <img src="<?php bloginfo("template_directory"); ?>/images/49/2.jpg" alt="">
            </div>
         </div>
      </div>
   </div>
   <div class="svg-banner">
      <img src="<?php bloginfo("template_directory"); ?>/images/49/3.jpg" alt="Svg-Banner">
   </div>
</div>