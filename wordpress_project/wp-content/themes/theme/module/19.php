            ...
            <div class="col-md-9">
                <div class="col-content-left">
                    <div class="heading-img">
                        <img src="<?php bloginfo("template_directory"); ?>/images/event-featured-img-1.jpg" alt="event-featured">
                    </div>
                        ...
                        <div class="content-buynow">
                            <div class="row buynow">
                                <div class="col-lg-6 col-md-12 col-sm-6 col">
                                    <h4>Accommodation</h4>
                                    <img src="<?php bloginfo("template_directory"); ?>/images/event-img-1-2.jpg"
                                        alt="event-img-1-2">
            ...
            <div class="col-md-3">
                <div class="col-sidebar-right">
                    <div class="sidebar-img">
                        <img src="<?php bloginfo("template_directory"); ?>/images/event-sidebar-img-1-300x212.jpg"
                            alt="event-sidebar">
                    </div>
                        ...
                        <ul>
                            <li>
                                <div class="inner-item">
                                    <div class="inner-img-banner">
                                        <a href=""><img
                                        src="<?php bloginfo("template_directory"); ?>/images/blog-masonry-img-2-150x150.jpg"
                                                alt=""></a>
                                    </div>
                            ...
                            <li>
                                <div class="inner-item">
                                    <div class="inner-img-banner">
                                        <a href=""><img
                                        src="<?php bloginfo("template_directory"); ?>/images/blog-img-3-150x150.jpg"
                                                alt=""></a>
                                    </div>
                                    <div class="inner-banner-item">
                                        <div class="inner-content">
                            ...
                            <li>
                                <div class="inner-item">
                                    <div class="inner-img-banner">
                                        <a href=""><img
                                        src="<?php bloginfo("template_directory"); ?>/images/blog-img-1-150x150.jpg"
                                                alt=""></a>
                                    </div>
                                    <div class="inner-banner-item">
                                        <div class="inner-content">
                    ...
                    <div class="banner-heineken-img">
                        <a href="#">
                            <img src="<?php bloginfo("template_directory"); ?>/images/event-sidebar-banner-1.jpg" alt="">
                        </a>
                    </div>
                    <div class="banner-skiathos-img">
                        <img src="<?php bloginfo("template_directory"); ?>/images/event-sidebar-banner-2.jpg" alt="">
                    </div>
                </div>
            </div>
        </div>
