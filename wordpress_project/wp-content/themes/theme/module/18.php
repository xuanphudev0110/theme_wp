...
<div class="type-18">
    <div class="row">
        ...
        <div class="col-md-3">
            <div class="img-1">
                <img src="<?php bloginfo("template_directory"); ?>/images/contact/18.jpg" alt="">
            </div>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            <div class="img-1">
                <img src="<?php bloginfo("template_directory"); ?>/images/contact/18.1.jpg" alt="">
            </div>
        </div>
        <!--  -->
        <div class="col-md-3">
            <div class="img-1">
                <img src="<?php bloginfo("template_directory"); ?>/images/contact/18.2.jpg" alt="">
            </div>
        </div>
        <div class="col-md-3">
        ...
        <div class="col-md-3">
            <div class="img-1">
                <img src="<?php bloginfo("template_directory"); ?>/images/contact/18.3.jpg" alt="">
            </div>
        </div>
        <div class="col-md-3">
            <div class="sufring-content">
        ...
        <div class="col-md-3">
            <div class="img-1">
                <img src="<?php bloginfo("template_directory"); ?>/images/contact/18.4.jpg" alt="">
            </div>
        </div>
        <div class="col-md-3">
            <div class="saling-content">
        ...
        <div class="col-md-3">
            <div class="img-1">
                <img src="<?php bloginfo("template_directory"); ?>/images/contact/18.5.jpg" alt="">
            </div>
        </div>
        <!--  -->
        <div class="col-md-3">
            <div class="img-1">
                <img src="<?php bloginfo("template_directory"); ?>/images/contact/18.6.jpg" alt="">
            </div>
        </div>
        <div class="col-md-3">
            <div class="sufringfor-content">
        ...
        <div class="col-md-3">
            <div class="img-1">
                <img src="<?php bloginfo("template_directory"); ?>/images/contact/18.7.jpg" alt="">
            </div>
        </div>
        <div class="col-md-3">
            <div class="sufring-content">
