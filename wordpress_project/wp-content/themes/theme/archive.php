			...
			<div class="col-md-9">
				<div class="swiper-container">
					...
					<div class="swiper-slide">
						<img src="<?php bloginfo("template_directory"); ?>/images/2.jpg" alt="Relax1">
					</div>
					<div class="swiper-slide">
						<img src="<?php bloginfo("template_directory"); ?>/images/4.jpg" alt="Relax2">
					</div>
					<div class="swiper-slide">
						<img src="<?php bloginfo("template_directory"); ?>/images/3.jpg" alt="Relax3">
					</div>
					<div class="swiper-slide">
						<img src="<?php bloginfo("template_directory"); ?>/images/4.jpg" alt="Relax4">
					</div>
					<div class="swiper-slide">
						<img src="<?php bloginfo("template_directory"); ?>/images/7.jpg" alt="Relax4">
					</div>
					</div>
					<!-- Add Arrows -->
...
<?php
get_template_part('module/49');
get_template_part('module/53');
?>
